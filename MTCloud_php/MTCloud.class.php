...
class MTCloud{
    ...
    */
     ...
     * @return array
     */
    public function zhuboUploadWatermark($account, $accountType, $filename) {
        $params = array('account' => $account,'accountType' => $accountType);
        $ret = $this->call('zhubo.watermark.uploadurl', $params);
     ...
     * @param  string $account      主播账号
     * @param  int    $accountType  主播账号类型
     * @param  int    $enable       是否启用主播摄像头水印
     * @return array
     */
    public function zhuboUpdateWatermark($account, $accountType, $enable) 
    {
        $params = array(
            'account' => $account,
        ...
        return $this->call('zhubo.watermark.update', $params);
    }
    ...
    */
     ...
     *  @return
     */
    public function coursePushRtmpUrl($course_id, $width = 1, $height = 10) {
        $params = array(
            'course_id' => $course_id,
            'width'     => $width,
            'height'    => $height
